...
const recipes: Record<SignalId, LessonRecipe> = {
  thread_hygiene: {
    ...
    principle:
      "Continue preserves momentum. Fork preserves useful decisions without the debris. Fresh protects an unrelated goal from inherited assumptions.",
    challengePrompt:
      "The strategy is approved. You now need Codex to build a separate deliverable. Which door gives the next task the cleanest useful context?",
    defaultScenario:
      "You have spent 38 turns shaping a client onboarding workshop. The decisions are sound, but the thread also contains rejected agendas and several dead ends. Now you need a polished follow-up page.",
    choices: [
      {
        id: "continue",
        label: "Continue here",
